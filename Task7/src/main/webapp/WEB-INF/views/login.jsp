    ...
    <div class="container-fluid" style="font-size: 10px">
        <div class="row cb-slideshow-text-container ">
            <div class="tm-content col-xl-6 col-sm-8 col-xs-8 ml-auto section">
                ...
                <form action="${pageContext.request.contextPath}/user/login" method="post" class="subscribe-form" >
                        ...
                        <table border="0">
                            ...
                            <tr>
                                <td colspan="2">
                                    <br>
                                    <div align="center">
                                        <input type="submit"  value="登录" href="${pageContext.request.contextPath}/user/login" style="color:#BC8F8F"/>
                                        <input type="submit" value="注册" href="${pageContext.request.contextPath}/user/register/0" style="color:#BC8F8F">
                                    </div>
                                </td>
                            </tr>
                        </table>
